...
public class ArrayList_ {
    ...
    public static void main(String[] args) {
         ...
         * ArrayList allows n number null and n number duplicate values.
        ...
        // 1.Way - Can store only 1 specified data type
         ...
         * 	It will replace the existing value with new one in mentioned index,
         *  only index,like replace in String
         *  works by index.
